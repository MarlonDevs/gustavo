    ...
    <Card class="col-span-1 mt-2 dark:bg-darkmode-600 shadow-md">
      ...
      <CardContent>
        ...
        <div class="grid grid-cols-2 gap-3">
          ...
          <Input type="text" placeholder="Numero de bien del Equipo" />
        </div>
        <div class="grid grid-cols-2 gap-3">
          <Input type="text" placeholder="Ubicacion del Equipo" />
          <Input type="text" placeholder="Aquien pertenece del Equipo" />
        </div>
